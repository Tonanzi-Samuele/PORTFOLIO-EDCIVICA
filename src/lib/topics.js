...
export const anni = [
        ...
        progetti: [
          {
            ...
            foto: ['/COD.png'],
            link: [{testo:'VAI ALLA PRESENTAZIONE',url:'https://docs.google.com/presentation/d/1Us90et38k3cCf6-6eAT3h5bcXPkNgxhTDCMECTJLtaM/edit?usp=sharing'},
                   {testo: 'GITHUB',url:'https://github.com/Tonanzi-Samuele/codice_fiscale'}
            ]
          }
        ]
      },
        ...
        progetti: [
          {
            ...
            foto: ['/ndrangheta.png'],
             link: [{
            testo:"PRESENTAZIONE",url:"https://canva.link/0c9ag610no3mww1"
            }]
          }
        ]
      }
  ...
  },
  {
    ...
    materie: [
      ...
      //     {
      //       id: 'quiz-patente',
      //       titolo: 'Quiz della Patente',
      //       tipo: 'Progetto in Python',
      //       descrizione: '[Inserisci qui la descrizione del progetto sul quiz della patente.]',
      //       foto: [],
      //       link: []
      //     }
      //   ]
        ...
        progetti: [
          {
            ...
            foto: ['/amish.png'],
            link: [
              {testo:'VAI ALLA PRESENTAZIONE',url:'https://docs.google.com/presentation/d/1NXaojzMIjfVXJlawmFspJkkZMN6Wlf4NffAA7Az1_eE/edit?usp=sharing'}
            ]
          }
        ]
      }
        ...
        progetti: [
          {
            ...
            foto: ["1522.png"],
            link: [{
              testo:"GITHUB",url:"https://github.com/Tonanzi-Samuele/1522"
            }]
          }
        ]
      },
